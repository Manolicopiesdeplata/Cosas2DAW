...
function transformarEnEditable(nodo) {
  ...
  if (editando == false) {
    ...
    filaEditando = nodoTr; // guardamos la fila que se edita

    let nodoContenedorForm = document.getElementById("contenedorForm"); // DIV
    ...
    let nuevoCodigoHtml =
      '<td><input type="text" name="alimento" id="alimento" value="' +
      alimento +
      '" size="10"></td>' +
      '<td><input type="text" name="calorias" id="calorias" value="' +
      calorias +
      '" size="5"></td>' +
      '<td><input type="text" name="grasas" id="grasas" value="' +
      grasas +
      '" size="5"></td>' +
      '<td><input type="text" name="proteina" id="proteina" value="' +
      proteina +
      '" size="5"></td>' +
      '<td><input type="text" name="carbohidratos" id="carbohidratos" value="' +
      carbohidratos +
      '" size="5"></td>' +
      '<td>En edición</td>';
    ...
    nodoContenedorForm.innerHTML =
      ...
      '<form name="formulario" onsubmit="capturarEnvio(event)" onreset="anular()">' +
...
function capturarEnvio(event) {
  ...
  // Actualiza la fila que se estaba editando
  filaEditando.innerHTML =
    ...
    "<td>" +
    carbohidratos +
    '</td><td><span class="editar" onclick="transformarEnEditable(this)">Editar</span></td>';
